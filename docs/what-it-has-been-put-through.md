...
**278 tests** (2026-09-20), on macOS and on Linux under bubblewrap, and in CI on
...
not installed, so on a machine without it the suite reports 260 passing and 18
...
|---|---|---|
| the suite | **278/278, nothing skipped** — 2026-09-20 | **278/278, nothing skipped** — 2026-09-20, `ubuntu-latest` in CI, Node 22, the eighteen sandbox tests confirmed run. Last full Docker run: 225/225 — 2026-09-14, Debian 12.15, bwrap 0.8.0, `--privileged` (bubblewrap mounts `/proc`) |
