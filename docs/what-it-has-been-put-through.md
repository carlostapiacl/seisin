...
**323 tests** (2026-09-21), on macOS and on Linux under bubblewrap, and in CI on
...
not installed, so on a machine without it the suite reports 297 passing and 26
...
|---|---|---|
| the suite | **323/323, nothing skipped** — 2026-09-21 | **323/323, nothing skipped** — 2026-09-21, `ubuntu-latest` in CI, Node 22, the twenty-six sandbox tests confirmed run. Last full Docker run: 225/225 — 2026-09-14, Debian 12.15, bwrap 0.8.0, `--privileged` (bubblewrap mounts `/proc`) |
